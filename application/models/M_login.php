...
class m_login extends CI_Model {
	...
	$query2		= $this->db->query("SELECT * FROM user WHERE email='$username' AND password='$password' AND status='1' ");
	$query4 	= $this->db->query("SELECT * FROM user WHERE email='$username'");
