    ...
    <div class="header">
      <div class="container">
        <a class="site-logo" href="index.html"><img src="<?=base_url('assets');?>/image/logo_brevet.png" alt="Brevet A & B Terpadu | Tax Center Universitas Gunadarma" width="200px" height="40px"></a>
