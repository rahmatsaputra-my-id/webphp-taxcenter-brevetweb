              ...
              <div class="row">
                <div class="col-md-8 col-sm-8">
                  <form class="form-horizontal" action="<?=base_url();?>index/createregister" method="post"role="form">
                    <fieldset>
                      ...
                      <div class="form-group">
                        <label class="col-lg-4 control-label">Kursus yang Dipilih <span class="require">*</span></label>
                        <div class="col-lg-8">
                      ...
                      <div class="form-group">
                        <label class="col-lg-4 control-label">Domisili Kampus <span class="require">*</span></label>
                        <div class="col-lg-8">
                ...
                <div class="col-md-4 col-sm-4 pull-right">
				  ...
				  <div class="form-info">
                    ...
                    <p>Untuk Pembayaran dapat datang langsung ke ruang D117 tax center universitas gunadarma.</p>
					<!--<button type="button" class="btn btn-default">More details</button>-->
                  </div>
				  <div class="form-info">
