...
<head>
  <meta charset="utf-8">
  <title>Brevet A & B Terpadu| Tax Center Universitas Gunadarma</title>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-4 col-sm-6 pre-footer-col">
            <h2>Tentang Kami</h2>
            <p>Kursus ini kami selenggarakan untuk mengedukasi mahasiswa universitas gunadarma dalam bidang perpajakan di indonesia.</p>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-4 col-sm-4 padding-top-10">
            2017 © Brevet A & B Terpadu. ALL Rights Reserved 
          </div>
          <!-- END COPYRIGHT -->
          <!-- BEGIN PAYMENTS -->
