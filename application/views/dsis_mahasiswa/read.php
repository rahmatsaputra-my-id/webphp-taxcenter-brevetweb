                                    ...
                                    <tbody>
                                        ...
                                        <tr class="odd gradeX">
                                            ...
                                            <td><?php $image = $row->gambar;
                                                    if ($image) { echo "<img src='".base_url('assets/upload/siswa/'.$image)."' alt='User Image' width='35' height='50'>";}else{ echo "<a class='btn btn-primary' name='edit' href=".base_url($linkupload.$row->id)."><i class='fa fa-file-image-o fa-fw'></i></a>";} ;?></td>
