                                    ...
                                    <tbody>
                                        ...
                                        <tr class="odd gradeX">
                                            ...
                                            <td><?php $image = $row->nama_modul;
                                                    if ($image) { echo "<a class='btn btn-primary' name='edit' href=".base_url('assets/upload/modul/'.$image)."><i class='fa fa-file-pdf-o fa-fw'></i></a>";}else{ echo "<a class='btn btn-warning' name='edit' href=".base_url($linkupload.$row->id)."><i class='fa fa-file-pdf-o fa-fw'></i></a>";} ;?></td>
