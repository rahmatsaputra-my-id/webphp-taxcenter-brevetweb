        <section class="content">
          ...
          <div class="box">
            ...
            <div class="box-body">
                  <table class="table">
                    <tr>
                      <td colspan='4' align="center"><strong> PROFILE MAHASISWA</strong></td>
                    </tr>
                    <?php foreach ($query->result() as $list) { ?>
                    <tr>
                      <td width='49%' align='right'>NPM</td>
                      <td width='2%'>:</td>
                      <td width='49%'><?=$list->npm;?></td>
                    </tr>
                    <tr>
                      <td width='49%' align='right'>Kelas</td>
                      <td width='2%'>:</td>
                      <td width='49%'><?=$list->kelas;?></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      <td width='49%' align='right'>Jurusan</td>
                      <td width='2%'>:</td>
                      <td width='49%'><?=$list->jurusan;?></td>
                    </tr>
                    <tr>
                      <td width='49%' align='right'>Fakultas</td>
                      <td width='2%'>:</td>
                      <td width='49%'><?=$list->fakultas;?></td>
                    </tr>
                    <tr>
                      <td width='49%' align='right'>Domisili</td>
                      <td width='2%'>:</td>
                      <td width='49%'><?=$list->domisili;?></td>
                    </tr>
                    <tr>
